...
const NonLinearLearning = () => {
  ...
  const [currentView, setCurrentView] = useState('fragments');
  ...
  const handleActivateFragment = useCallback((fragmentId) => {
  ...
  const NetworkView = () => {
    ...
    const isNodeInView = useCallback((node, viewport) => {
      const padding = 100;
      return (
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button 
              ...
              onClick={() => showToast("🚧 ¡Función no implementada!")}
            >
      ...
      <div className="flex-1 overflow-hidden">
        {currentView === 'fragments' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
            {/* Fragment List */}
            <div className="md:col-span-1 overflow-y-auto space-y-4 p-1">
              <AnimatePresence>
            ...
            <div className="md:col-span-2 glass-effect rounded-xl p-6 overflow-y-auto">
              {selectedFragment ? (
                <motion.div
